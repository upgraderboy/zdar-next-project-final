        ...
        <>
            ...
            <SignedOut>
                <SignInButton mode="modal">
                    <Button className="px-4 py-2 text-sm font-medium bg-white text-[#29465B] hover:text-[#29465B] border-blue-500/20 rounded-full shadow-none [&_svg]:size-4" variant="ghost">
