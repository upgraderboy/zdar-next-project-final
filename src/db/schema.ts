...
export const jobTypeEnum = pgEnum("job_type", ["Full-Time", "Part-Time", "Internship"]);
...
export const jobs = pgTable("jobs", {
    ...
    jobType: jobTypeEnum("job_type").default("Full-Time").notNull(), // e.g., Full-Time, Part-Time, Internship
